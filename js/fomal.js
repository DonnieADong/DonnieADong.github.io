...
function tonav() {
    ...
    document.getElementById("page-name").innerText = document.title.split(" | 阿东の小窝☃️")[0];
}
...
/* 欢迎信息 start */
//get请求-通过第三方接口，获取IP地址
$.ajax({
    type: 'GET',
    // 这里使用了ipify API提供的公共服务
    ...
    success: function (res) {
        ...
        $.ajax({
            ...
            data: {
                key: 'GQ5BZ-PSQL5-5XWIU-IYKG5-HZBKT-BKB4T',
                output: 'jsonp',
                ip: localhostIp,
            },
            dataType: 'jsonp',
...
function showWelcome() {
    //距离计算-站点经纬度
    let dist = getDistance(120.4592084, 36.1138227, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
    ...
    else if (date.getHours() >= 16 && date.getHours() < 19) timeChange = "<span>夕阳无限好！</span>，只是?";
    ...
    try {
        ...
        document.getElementById("welcome-info").innerHTML =
            `<b><center>🎉 欢迎信息 🎉</center>&emsp;&emsp;欢迎来自 <span style="color:var(--theme-color)">${pos}</span> 的小伙伴，${timeChange}您现在距离站长约 <span style="color:var(--theme-color)">${dist}</span> 公里，当前的IP地址为：<span style="color:var(--theme-color); word-wrap: break-word;">${ip}</span>， ${posdesc}</b>`;
    } catch (err) {
...
function createtime2() {
    //随机弹出识别为哪种人
    let nameList = ['千里马', '白富美', '高富帅', '白嫩嫩', '水灵灵', '娇滴滴', '俏佳丽', '女强人', '赛诸葛', '俏皮猫', '领头羊',
        '老黄牛', '活菩萨', '女才人', '花木兰', '铁将军', '酷毙了', '帅呆了', '美极了', '我女神', '大富翁', '小绵羊', '神枪手', '肌肉男',
        '机灵鬼', '颜值控', '小美女', '大聪明', '大善人', '大英雄', '大富豪', '大学者', '赛潘安', '胜孔明', '比子龙', '超关羽'];
    var result = nameList[Math.floor(Math.random() * nameList.length)];
    var ascll2 = [`NCC2-036`, "调用前置摄像头拍照成功，识别为「" + result + "」", `Photo captured: `, ` 🤪 `];
    ...
    setTimeout(console.log.bind(console, "%c WELCOME %c 欢迎光临，" + result, "color:white; background-color:#23c682", ""));

    setTimeout(
        console.warn.bind(
            console,
            "%c ⚡ Powered by DonnieADong☃ %c 你正在访问阿东の小窝☃",
...
function share_() {
    ...
    try {
        ...
        var subTitle = title.endsWith("| DonnieADong☃️") ? title.substring(0, title.length - 14) : title;
        navigator.clipboard.writeText('DonnieADong☃️的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
        new Vue({
            data: function () {
                this.$notify({
                    title: "成功复制分享信息🎉",
...
var lunarInfo = [19416, 19168, 42352, 21717, 53856, 55632, 91476, 22176, 39632, 21970, 19168, 42422, 42192, 53840, 119381, 46400, 54944, 44450, 38320, 84343, 18800, 42160, 46261, 27216, 27968, 109396, 11104, 38256, 21234, 18800, 25958, 54432, 59984, 28309, 23248, 11104, 100067, 37600, 116951, 51536, 54432, 120998, 46416, 22176, 107956, 9680, 37584, 53938, 43344, 46423, 27808, 46416, 86869, 19872, 42416, 83315, 21168, 43432, 59728, 27296, 44710, 43856, 19296, 43748, 42352, 21088, 62051, 55632, 23383, 22176, 38608, 19925, 19152, 42192, 54484, 53840, 54616, 46400, 46752, 103846, 38320, 18864, 43380, 42160, 45690, 27216, 27968, 44870, 43872, 38256, 19189, 18800, 25776, 29859, 59984, 27480, 23232, 43872, 38613, 37600, 51552, 55636, 54432, 55888, 30034, 22176, 43959, 9680, 37584, 51893, 43344, 46240, 47780, 44368, 21977, 19360, 42416, 86390, 21168, 43312, 31060, 27296, 44368, 23378, 19296, 42726, 42208, 53856, 60005, 54576, 23200, 30371, 38608, 19195, 19152, 42192, 118966, 53840, 54560, 56645, 46496, 22224, 21938, 18864, 42359, 42160, 43600, 111189, 27936, 44448, 84835, 37744, 18936, 18800, 25776, 92326, 59984, 27424, 108228, 43744, 41696, 53987, 51552, 54615, 54432, 55888, 23893, 22176, 42704, 21972, 21200, 43448, 43344, 46240, 46758, 44368, 21920, 43940, 42416, 21168, 45683, 26928, 29495, 27296, 44368, 84821, 19296, 42352, 21732, 53600, 59752, 54560, 55968, 92838, 22224, 19168, 43476, 41680, 53584, 62034, 54560],
    ...
    nStr1 = ["日", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十"], nStr2 = ["初", "十", "廿", "卅"],
...
var newYear = () => {
    ...
    jQuery(document).ready(function ($) {
        $('#newYear').wpSuperSnow({
            flakes: ['/img/webp/yb1.webp', '/img/webp/yb2.webp', '/img/webp/yb3.webp'],
            totalFlakes: '100',
            zIndex: '999999',
            maxSize: '30',
            maxDuration: '20',
...
function createtime() {
    ...
    (currentTimeHtml =
        hnum < 18 && hnum >= 9
            ? `<img class='boardsign' src='/img/svg/摸鱼.svg' title='摸鱼时间到~'><br> <div style="font-size:13px;font-weight:bold">本站已经运行 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
            : `<img class='boardsign' src='/img/svg/游戏.svg' title='终于下班啦~'><br> <div style="font-size:13px;font-weight:bold">本站已经运行 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
// 切换背景函数，此处的flag是为了每次读取时都重新存储一次,导致过期时间不稳定，如果flag为0则存储,即设置背景. 为1则不存储,即每次加载自动读取背景.
...
<div class="content" style="display:flex">
  ...
  <div class="content-text" style="font-weight:bold; padding-left:20px"> 侧边栏 (默认打开) </div><input type="checkbox" id="rightSideSet" onclick="toggleRightside()">
</div>

<div class="content" style="display:flex">
  <div class="content-text" style="font-weight:bold; padding-left:10px"> 帧率监测 (刷新生效) </div><input type="checkbox" id="fpson" onclick="fpssw()">
  <div class="content-text" style="font-weight:bold; padding-left:20px"> 飘雪花 (白天模式) </div><input type="checkbox" id="snowSet" onclick="setSnow()">
</div>


<h2>二、字体设置</h2>
<p id="swfs">
<a class="swf" id="swf_CEYM" href="javascript:;" rel="noopener external nofollow" style="font-family:'CEYM'!important;color:black" onclick="setFont('CEYM')">仓耳与墨</a>
<a class="swf" id="swf_HYKTF" href="javascript:;" rel="noopener external nofollow" style="font-family:'HYKTF'!important;color:black" onclick="setFont('HYKTF')">汉仪楷繁</a>
<a class="swf" id="swf_HCZKT" href="javascript:;" rel="noopener external nofollow" style="font-family:'HCZKT'!important;color:black" onclick="setFont('HCZKT')">寒蝉正楷</a>
<a class="swf" id="swf_AL_DYH" href="javascript:;" rel="noopener external nofollow" style="font-family:'AL_DYH'!important;color:black" onclick="setFont('AL_DYH')">得意斜黑</a>
<a class="swf" id="swf_HYXXM" href="javascript:;" rel="noopener external nofollow" style="font-family:'HYXXM'!important;color:black" onclick="setFont('HYXXM')">汉仪熊猫</a>
<a class="swf" id="swf_HFSDZHLSCJ" href="javascript:;" rel="noopener external nofollow" style="font-family:'HFSDZHLSCJ'!important;color:black" onclick="setFont('HFSDZHLSCJ')">和风龙神</a>
<a class="swf" id="swf_AL_FYT" href="javascript:;" rel="noopener external nofollow" style="font-family:'AL_FYT'!important;color:black" onclick="setFont('AL_FYT')">方圆体</a>
...
<div class="note warning modern"><p>    非商免字体未经授仅限个人使用。本站为完全非商业、非盈利性质的网站，平时用于个人学习交流，如有侵权请联系站长删除，谢谢！</p>
<p style="text-align: right;margin-right: 2em">—— 致版权方</p></div>
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm1.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm2.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm3.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm4.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm5.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm6.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm7.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm8.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/ecy/dm9.webp)" class="imgbox" onclick="changeBg('url(/img/webp/ecy/dm9.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj1.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj2.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj3.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj4.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj5.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj6.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj7.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/fj/fj8.webp)" class="imgbox" onclick="changeBg('url(/img/webp/fj/fj8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc1.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc2.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc3.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc4.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc5.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc6.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc7.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/mc/mc8.webp)" class="imgbox" onclick="changeBg('url(/img/webp/mc/mc8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb1.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb2.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb3.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb4.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb5.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb6.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb7.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb8.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/webp/sj/mb9.webp)" class="pimgbox" onclick="changeBg('url(/img/webp/sj/mb9.webp)')"></a></div>
              </div>
            </details>
